...
public class BluetoothScanModeEnforcer {
    ...
    public BluetoothScanModeEnforcer(Context context, BluetoothAdapter btAdapter, CompanionTracker companionTracker) {
        mAdapter = btAdapter;
    ...
    public void dump(IndentingPrintWriter ipw) {
        ...
        int count = getBondedClassicPeripheralCount();
        ipw.println("Bluetooth Peripherals Count: " + getBondedClassicPeripheralCount());
